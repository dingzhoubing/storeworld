...
//		});
		...
		combo_customer.add("丁源熊");
		combo_customer.add("苏锴");
		combo_customer.add("苏州");
		ArrayList<String> tt = new ArrayList<String>();
		tt.add("丁源熊");
		tt.add("苏锴");
		tt.add("苏州");
		String[] ary = new String[3];
		head_char=tt.toArray(ary);
		...
		combo_customer.addKeyListener(new KeyAdapter(){
			...
			public void keyReleased(KeyEvent e0){
				...
				int act_num=combo_customer.getItemCount();//下拉框中的实际用户数
				combo_customer.remove(0, act_num-1);//将下拉框清空
//				combo_customer.setText(index_str);
//				combo_customer.removeAll();
				...
				combo_customer.setListVisible(true);
		}
		});
