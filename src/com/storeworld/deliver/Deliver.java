...
public class Deliver{
	...
	public Deliver(String brand,String sub_brand,String size,String unit, double price, int number){
		this(null, brand,sub_brand,size,unit,price, number);
	}
	public Deliver(String ID, String brand,String sub_brand,String size,String unit, double price, int number){
		if(ID != null)		
			this.id = ID;
		this.brand = brand;
