...
//		return false;
	...
	public static boolean validateName(String brand){//Table table, TableItem item, int col, 
		if(brand != null && !brand.equals("") && !brand.equals("123")){
	...
	public static boolean validateArea(String brand){//Table table, TableItem item, int col, 
		if(brand != null && !brand.equals("") && !brand.equals("123")){
